...
const Navbar = () => {
  ...
  return (
    ...
    >
      <img src={logo} alt="hokbank" className="w-[124px] h-[32px]" />
      <ul
      ...
      >
        ...
        <div
         ...
         absolute top-20 right-0 mx-4 my-2 min-w-[140px] rounded-x rouded-x1 sidebar`}
        >
          <ul
            className="list-none flex 
         justify-end items-center flex-1 flex-col"
          >
            {navLinks.map((nav, index) => (
              <li
                key={nav.id}
