...
const Billing = () => {
  return (
    ...
    <div className={layout.sectionImgReverse}>
      <img src={bill} alt='bil' className=
...
lorem vfddhnvbv mnvjfhn zkxmxnckckck 
bsfdgtudhc  mshgvcbkucn kdbcncvvc
bvbfgjdku mcnffhdfgdj mdhfgbcvsfdyf
      </p>
      <div className='flex flex-row flex-wrap sm:mt-10 mt-6'>
        <img src={apple}  alt='apple' className=
        'w-[128px] h-[48px] object-contain mr-5 cursor-pointer'/>
        <img src={google}  alt='google' className=
        'w-[128px] h-[48px] object-contain cursor-pointer'/>
      </div>
    </div>
    </section>
  )
