      ...
      >
        ...
        >
          <h1
           ...
           text-white font-semibold ss:text-[72px] text-[52px]
        ...
        <h1
          className=" font-poppins  
           text-white font-semibold ss:text-[68px] text-[52px]
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          {" "}
          Our Team of expert uses methodogy to identify the credit cards most
