  ...
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
    ...
    >
      <div className=" flex-1 flex flex-col justify-start mr-10 ">
        ...
        />
        <p className={`${styles.paragraph} max-w-[310px] mb-5 mt-5`}>
          {" "}
        ...
        {footerLinks.map((footer) => (
          ...
          leading-[27px] text-white "
            ...
            <ul className="list-none mt-4">
              ...
              font-normal text-[16px]  text-dimWhite leading-[24px]
    ...
    justify-between items-center
     md:flex-row flex-col pt-6
     border-t-[1px] border-t-[#3r45] '>
      <p
        className=" font-poppins font-normal 
    text-center text-[18px] leading-[27px] text-white"
      >{date} HooBank. &copy; All Right Reserved  </p>
